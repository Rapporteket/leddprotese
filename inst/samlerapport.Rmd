...
params:
  ...
  bins: 5
title: Samlerapport
subtitle: en eksempelrapport fra leddprotese
author: Rapporteket
userFullName: Tore Tester
registryName: SKDE
reglogo: '`r system.file("logo.png", package = "leddprotese")`'
regtext: '`r readLines(system.file("shortDescription.txt", package = "leddprotese"))`'
...
f <- leddprotese::makeSimpleHist(df = mtcars, var = params$var, bins = params$bins, makeTable = FALSE)
```
